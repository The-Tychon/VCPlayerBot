...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('🔮Update Channel🔥', url='https://t.me/Electro_updates'),
            InlineKeyboardButton('🔥Owner🔥', url='https://t.me/itz_me_tychon')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        ...
        [
            InlineKeyboardButton("🔥Status Channel🔥", url='https://t.me/cyber_hunters_status'),
            InlineKeyboardButton('🗑 Close', callback_data='close'),
        ]
    ]
    await message.reply("<b>The source code of this bot is public and can be found at <a href=https://t.me/itz_me_tychon>VCPlayerBot.</a>\nYou can deploy your own bot and use in your group.\n\nFeel free to star☀️ the repo if you liked it 🙃.</b>", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
    await delete_messages([message])
